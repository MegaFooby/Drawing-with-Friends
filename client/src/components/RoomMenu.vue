      ...
      <v-row>
       ...
       >
        <v-card
          ...
          @click="createRoom"
        >
          <v-card-text v-text="'Create a new room'" class="text-h5"></v-card-text>
          <v-icon
            large
...
export default class RoomMenu extends Vue {
  ...
  updateRoomsHeight() {
    ...
    this.roomsHeight = window.innerHeight - logo?.$el.clientHeight - buttons?.clientHeight;
  }
